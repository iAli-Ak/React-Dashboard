...
const Notifications = () => {
  ...
  return (
    <div className='w-72 height-full fixed p-3 rounded-md top-14 right-48 dark:text-gray-200 bg-white dark:bg-[#484B52]'>
    <div className='flex flex-wrap h-full overflow-y-auto'>
    <p className='p-2 font-semibold'>Notifications</p>
    <p
